...
const Index = () => {
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-8 mt-14">
          ...
          <div className="bg-storybook rounded-3xl p-12 space-y-6">
            ...
            <Link to={'/books'}>
            <Button className="bg-gradient-magic text-lg px-8 py-4 h-auto">
              Explore All Stories
            </Button>
            </Link>
          </div>
  ...
  <div className="container mx-auto px-4">
    <div className="text-center mb-16">
      <Badge className="bg-primary/10 text-primary mb-14 px-4 py-2">
        <Star className="w-4 h-4 mr-2" />
        Categories by Age
      </Badge>
    ...
    <div className="grid md:grid-cols-3 gap-8">
      {[
        ...
        <Card
          key={category.title}
          className="group border-0 bg-card hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden"
        ...
        >
          ...
          <CardContent className="p-6">
            ...
            <Link to="/books">
              <Button className="w-full bg-gradient-magic hover:shadow-lg transition-all duration-300">
                Explore Stories
              </Button>
            </Link>
          </CardContent>
